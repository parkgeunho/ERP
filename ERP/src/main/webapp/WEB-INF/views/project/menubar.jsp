...
<div id="c">
	<div id="a" style="height: 100px; background-color: white;">
		...
		<div align="center" class="dtonumber" style="margin-left: 1085px;">${approvalCount }</div>
		<div align="center" class="dtonumber" style="margin-left: 1270px;">${scheduleCount }</div>
