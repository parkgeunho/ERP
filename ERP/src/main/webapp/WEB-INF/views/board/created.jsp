...
<table border="0" cellpadding="0" cellspacing="0" align="center" >
	...
	<tr style="height: 30px; background: #00D8FF" >
		<td style="width: 200px; height: 20px; color: white; font-size: 20px;" align="center" >제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목</td>
		<td style="width: 1372px;">
			<input type="text" name="subject" style="width:1000px; height: 20px;"/>	
		</td>	
	</tr>
	<tr style="height: 1px;">
		<td colspan="2"></td>
...
<table style="font-size: 15px;width: 1570px;" border="0"  cellspacing="0" align="center">	
	<tr style="width: 10px;">
		<td></td>
	</tr>
