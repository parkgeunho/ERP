...
<tr><td height="2" width="1000" style="background-color: #bbbbbb;"></td></tr>
	...
	<tr>
		<td align="center" style="font-size: 30pt; font-family: 고딕; font-weight: bold;">인사정보 수정</td>
	</tr>
...
<table border="0" width="1000"align="center" style="margin-top: 20px; margin-bottom: 0px;" cellpadding="0" cellspacing="0">
	<tr height="40">
		...
		<button type="button" style="width: 70px; height: 30px; font-size: 10pt; font-family: 고딕;" class="okbtn" onclick="javascript:location.href='<%=cp%>/insaView.action?num=${dto.num }';">취소</button>
		</td>
</table>
...
<table border="0" align="center" style="margin:0px ; border-radius : 10px;" cellpadding="0">
	<tr height="40">
		...
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.name }" class="dap_text_box" id="usr" name="name" placeholder="ex) 홍 길 동" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 95%;"></td>
		<td width="100" class="color" align="center">주민번호</td>
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.jumin }" class="dap_text_box" id="usr" name="jumin" placeholder="ex) 123456-1234567" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 400px;"></td>
	</tr>
	<tr height="40">
		<td width="100" class="color" align="center">주 소</td>
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.addr }" class="dap_text_box" id="usr" name="addr" placeholder="ex) 서울시 강남구 역삼동 ... " style="height: 35px; font-size: 15pt; font-family: 고딕; width: 95%;"></td>
		<td width="100" class="color" align="center">보안등급</td>
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.secure }" class="dap_text_box" id="usr" name="secure" placeholder="ex) 1 ~ 3" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 400px;"></td>
	</tr>
	<tr height="40">
		<td width="100" class="color" align="center">사내번호</td>
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.oPhone }" class="dap_text_box" id="usr" name="oPhone" placeholder="ex) 070-1234-5678" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 95%;"></td>
		<td width="100" class="color" align="center">휴대전화</td>
		<td width="400" colspan="3" align="center"><input type="text" value="${dto.mPhone }" class="dap_text_box" id="usr" name="mPhone" placeholder="ex) 010-1234-5678" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 400px;"></td>
	</tr>
	<tr height="40">
	...
	<tr height="40">
		...
		<select name="grade"  class="dap_text_box" id="usr" style="height: 35px; font-family: 고딕; width: 99%;">
   			<option value="${dto.grade }">${dto.grade}</option>
		...
		<td width="130"><input type="text" value="${dto.duty}" class="dap_text_box" id="usr" name="duty" placeholder="ex) 팀장" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 135px;"></td>
	</tr>
	<tr height="40">
		...
		<select name="blood" class="dap_text_box" id="usr" style="height: 35px; font-family: 고딕; width: 150px;">
   			<option value="${dto.blood }">${dto.blood }</option>
		...
		<td width="150" ><input type="text" value="${dto.reli }" class="dap_text_box" id="usr" name="reli" placeholder="ex) 기독교" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 90%;"></td>
		<td width="100" class="color" align="center">취 미</td>
		<td width="150" ><input type="text" value="${dto.hobby}" class="dap_text_box" id="usr" name="hobby" placeholder="ex) 농구" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 150px;"></td>
		<td width="100" class="color" align="center">근 태</td>
		<td width="130" ><input type="text" value="${dto.dal }" class="dap_text_box" id="usr" name="dal" placeholder="ex) 휴가" style="height: 35px; font-size: 15pt; font-family: 고딕; width: 135px;"></td>
	</tr>
	<tr height="40">
		<td width="100" class="color" align="center">메 모</td>
		<td width="400" colspan="8" ><textarea class="dap_text_box" id="usr" name="memo" placeholder="ex) 특이사항" style="height: 200px; font-size: 15pt; font-family: 고딕; width: 99%;">${dto.memo}</textarea></td>
	</tr>
